...
<strong>Note:</strong> This library also has a support for .NET Core applications. Please see the section <strong>[.NET Core Support](https://github.com/Shwetajain148/log4net-loggly/blob/test-readme/README.md#net-core-support)</strong> below.
